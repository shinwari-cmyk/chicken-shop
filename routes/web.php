...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    */
    ...
    Route::get('products/{product}/rates', 
        [ProductRateController::class, 'index']
    )->name('product_rates.index');

    Route::get('products/{product}/rates/create', 
        [ProductRateController::class, 'create']
    )->name('product_rates.create');

    Route::post('products/{product}/rates', 
        [ProductRateController::class, 'store']
    )->name('product_rates.store');

    Route::get('rates/{rate}/edit', 
        [ProductRateController::class, 'edit']
    )->name('product_rates.edit');

    Route::put('rates/{rate}', 
        [ProductRateController::class, 'update']
    )->name('product_rates.update');

    Route::delete('rates/{rate}', 
        [ProductRateController::class, 'destroy']
